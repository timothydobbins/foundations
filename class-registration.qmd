...
Welcome to Foundations of Biostatistics. This page summarises the different class registration options for this course. There are two main decisions you need to make:

1.  How you will attend lectures and tutorials
2.  What software you will use to learn biostatistics
...
-   join lectures live online (via Microsoft Teams), or;
...
If you would like to join tutorials online (either live or watching recordings), you should register for:
...
This course offers three **optional** software troubleshooting sessions in Weeks 1, 2 and 4 (denoted LAB on the timetable). Each session will be held in person in the Wallace Wurth building (Room G06), with an option to book an online appointment. The troubleshooting sessions will not be recorded.

If you would like to attend these sessions in person, you should register for:

-   10293 (LAB 1 - In person) if you are a post-graduate student, or;
-   10300 (LAB 1 - In person) if you are an undergraduate student.

We will also offer online troubleshooting appointments, which will be scheduled for the same time as the in-person sessions. If you would like to join the software troubleshooting sessions online, you should register for:
...
+--------------------+------------+-------------+-------------+--------------------------+
| Mode of attendance | Software   | Lecture     | Tutorial    | Software troubleshooting |
+====================+============+:===========:+:===========:+:========================:+
| In-person          | R          | 10288 LEC A | 10290 TUT C | 10293 LAB 1              |
|                    |            |             |             |                          |
|                    | Stata      | 10288 LEC A | 10291 TUT D | 10293 LAB 1              |
+--------------------+------------+-------------+-------------+--------------------------+
| Live online        | R          | 10289 LEC B | 10292 TUT E | 10294 LAB 2              |
|                    |            |             |             |                          |
|                    | Stata      | 10289 LEC B | 10292 TUT E | 10294 LAB 2              |
+--------------------+------------+-------------+-------------+--------------------------+
| Online recorded    | R          | 10289 LEC B | 10292 TUT E | 10294 LAB 2              |
|                    |            |             |             |                          |
|                    | Stata      | 10289 LEC B | 10292 TUT E | 10294 LAB 2              |
+--------------------+------------+-------------+-------------+--------------------------+
...
| Mode of attendance | Software   | Lecture     | Tutorial    | Software troubleshooting |
+====================+============+:===========:+:===========:+:========================:+
| In-person          | R          | 10295 LEC A | 10297 TUT C | 10300 LAB 1              |
|                    |            |             |             |                          |
|                    | Stata      | 10295 LEC A | 10298 TUT D | 10300 LAB 1              |
+--------------------+------------+-------------+-------------+--------------------------+
| Live online        | R          | 10296 LEC B | 10299 TUT E | 10301 LAB 2              |
|                    |            |             |             |                          |
|                    | Stata      | 10296 LEC B | 10299 TUT E | 10301 LAB 2              |
+--------------------+------------+-------------+-------------+--------------------------+
| Online recorded    | R          | 10296 LEC B | 10299 TUT E | 10301 LAB 2              |
|                    |            |             |             |                          |
|                    | Stata      | 10296 LEC B | 10299 TUT E | 10301 LAB 2              |
+--------------------+------------+-------------+-------------+--------------------------+
...
More information about this course can be found [here](https://timothydobbins.github.io/foundations/). If you have any questions, please email me at [t.dobbins\@unsw.edu.au](mailto:t.dobbins@unsw.edu.au).
