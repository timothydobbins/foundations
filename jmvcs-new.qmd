---
title: "Revised jamovi cheat sheet"
format:
  typst:
    papersize: a4
    margin:
...
-   **Download & Install:** Free at [`https://www.jamovi.org/download.html`](https://www.jamovi.org/download.html). Using the *Current Version* is fine. \[Section 1.9\]
...
-   **Set Value to Missing:** **Click** the cell with the incorrect value and press **Delete** or **Backspace**. Always keep an original, unedited copy of your data. \[Section 1.12\]
...
-   **Binomial** probabilities \[Section 2.17\]: <https://mabognar.github.io/apps/bin.html>
-   **Normal** probabilities \[Section 3.16\]: <https://mabognar.github.io/apps/normal.html>
...
-   **One-Sample T-test**: **Analyses \> T-Tests \> One Sample T-Test**. Select **dependent variable**, enter **Test value** (hypothesised mean). \[Section 4.16\]
