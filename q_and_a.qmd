...
Foundations of Biostatistics is taught using both in-person and online modes. Lectures are delivered in-person, and are also live-streamed and recorded. We have online tutorials which are recorded. There is also a weekly drop-in session that is available both in-person and online.
:::
...
If it has been a while since you have studied maths, the resources from [Unit 1 of the Algebra Basics from the Khan Academy](https://www.khanacademy.org/math/algebra-basics/basic-alg-foundations){.external target="_blank"} might be useful.
...
Do you have a question that is not answered here? Please [email me](mailto:phcm9795.biostats@unsw.edu.au), and I can provide an answer.
