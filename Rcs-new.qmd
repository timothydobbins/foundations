...
-   **Convert a single column to a data frame:** Some packages (e.g. `jmv`) can only work with data frames, not single columns. Convert a single column to a data frame using `as.data.frame()` (e.g., `age_df <- as.data.frame(age)`). \[Section 3.25\]
...
-   **Binomial** probabilities <https://mabognar.github.io/apps/bin.html>
...
-   **Normal** probabilities <https://mabognar.github.io/apps/normal.html>
